...
project2_second.out: project2_second.o
	g++ project2_second.o hash24.o -o project2_second.out 
...
project2_second.o: project2_second.cpp
	g++ -c project2_second.cpp project2_second.h project2_first.h hash24.h
	g++ -c hash24.cpp hash24.h

clean:
	rm -f project2_first project2_second *.o *.out *.gch